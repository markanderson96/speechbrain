...
class SpeakerBrain(sb.core.Brain):
    ...
    def on_stage_end(self, stage, stage_loss, epoch=None):
        ...
        if hasattr(self.modules.compute_features, 'leaf'):
            import numpy as np
            ...
            init = self.modules.compute_features.leaf.init_filter
            filterbank = self.modules.compute_features.leaf.filterbank
            ...
            np.save(
                f'output/efficientleaf_{init}_{epoch}.npy',
                freq_responses
            )
